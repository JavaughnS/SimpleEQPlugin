...
private:
    ...
    template<typename ChainType, typename CoefficientType> void
    updateCutFilter(ChainType& chain, const CoefficientType& coefficients, const Slope& slope)
    {
        ...
        switch ( slope )
        {
//          without the break; statement, the cases just cascade
            case Slope_48:
